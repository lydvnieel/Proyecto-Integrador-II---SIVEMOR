export default function DeleteClientsModal({
  ...
  return (
    <div className="modal fade" id="deleteClientsModal" tabIndex="-1" aria-hidden="true">
          ...
          <div className="modal-body">
            {selectedCount === totalCount ? (
              <>
                ...
                clientes seleccionados? Esta acción no se puede deshacer.
              </>
            ) : (
              <>
                ¿Estás seguro de que deseas eliminar <strong>{selectedCount}</strong>{" "}
                cliente{selectedCount > 1 ? "s" : ""} seleccionado
